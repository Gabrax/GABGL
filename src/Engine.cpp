...
void Engine::Run(){
    ...
    Shader shader("resources/camera.vert", "resources/camera.frag");
    float vertices[] = {
    ...
    unsigned int tex = loadTexture("resources/awesomeface.png");
    ...
    while (Window::WindowIsOpen() && Window::WindowHasNotBeenForceClosed()){  
        ...
        float bruh = Window::camera.Zoom;
        // pass projection matrix to shader (note that in this case it could change every frame)
        glm::mat4 projection = glm::perspective(glm::radians(bruh), (float)(1920 * 0.75f) / (float)(1920 * 0.75f), 0.1f, 100.0f);
